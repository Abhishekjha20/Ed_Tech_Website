...
import Single from '../assest/Image/single.png'
import Double from '../assest/Image/double.png'
import Triple from '../assest/Image/triple.png'

function Offer_plans() {
  return (
    <div className='w-full py-[10rem] px-4 bg-white'>
        <div className="max-w-[1240px] mx-auto md:grid grid-cols-3 gap-8">
            ...
            <img className='w-20 mx-auto mt-[-3rem] bg-transparent pt-[5px]' src={Double} alt="/" />
                    <h2 className='text-2xl font-bold text-center py-8'>Frontend Development</h2>
                    <p className='text-center text-4xl font-bold'>$149</p>
                    <div className='text-center font-medium'>
                        <p className='py-2 border-b mx-8 mt-8'>Lorem Ipsum is simply </p>
                        <p className='py-2 border-b mx-8'>Lorem Ipsum is simply dummy text of the printing</p>
            ...
            <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
            <img className='w-20 mx-auto mt-[-3rem] bg-white pt-[5px]' src={Triple} alt="/" />
